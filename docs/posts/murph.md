...
But last summer I started doing some murphs everyday without the vest. After doing that for a bit, I started doing one every so often with a vest[^1]. And then I said, why not try to do this for 30 days? I decided to post my progress here to keep myself accountable. I didn't end up hitting a murph every single day, but I'm happy with my progress.
...
[^1]: Official murphs use a 9kg/20lb vest, though the vest I had was only 8kg.*
