...
Recently, some [OSCP](https://www.offsec.com/courses/pen-200/) experience came in handy as I was trying to analyze and manipulate traffic that was going between a client and a web server over https. There's two tools that can do this job well:
